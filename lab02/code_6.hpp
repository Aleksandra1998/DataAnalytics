...
{" (found before start of program)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 24, column 2 to column 25)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 10, column 2 to column 20)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 11, column 2 to column 18)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 15, column 2 to column 14)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 16, column 2 to column 14)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 17, column 2 to column 13)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 19, column 2 to column 59)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 20, column 2 to column 44)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 3, column 4 to column 21)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 4, column 4 to column 64)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 5, column 4 to column 18)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_6.stan', line 2, column 66 to line 6, column 3)"};
...
tail_delta(const T0__& y_arg__, const T1__& theta_arg__,
  ...
  try {
    ...
    assign(deltas,
      ((2 *
         (normal_cdf(rvalue(theta, "theta", index_uni(1)), 0,
            stan::math::exp(rvalue(y, "y", index_uni(1)))) - 0.5)) - 0.99),
      "assigning variable deltas", index_uni(1));
 ...
 public:
    ...
    try {
      ...
      
      {
        ...
        for (int sym1__ = 1; sym1__ <= 1; ++sym1__) {
          current_statement__ = 2;
          assign(y_guess, y_guess_flat__[(pos__ - 1)],
            "assigning variable y_guess", index_uni(sym1__));
          current_statement__ = 2;
          pos__ = (pos__ + 1);
        }
      }
      ...
      context__.validate_dims("data initialization","theta","double",
           std::vector<size_t>{static_cast<size_t>(1)});
      theta__ = Eigen::Matrix<double, -1, 1>(1);
      ...
      if (pstream__) {
        ...
        stan_print(pstream__, stan::math::exp(rvalue(y, "y", index_uni(1))));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    try {
      ...
      sigma = stan::math::exp(rvalue(y, "y", index_uni(1)));
