...
{" (found before start of program)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_9.stan', line 5, column 2 to column 12)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_9.stan', line 6, column 2 to column 13)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_9.stan', line 10, column 4 to column 39)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_9.stan', line 9, column 2 to line 10, column 39)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_9.stan', line 12, column 2 to column 37)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_9.stan', line 2, column 0 to column 15)",
 " (in '/mnt/c/ola/DataAnalytics/lab02/code_9.stan', line 5, column 9 to column 10)"};
    ...
    try {
      ...
      theta = in__.template read<local_scalar_t__>();
      {
        ...
        for (int n = 1; n <= N; ++n) {
          ...
          lp_accum__.add(normal_lpdf<false>(y, theta, 1));
        }
        current_statement__ = 5;
        lp_accum__.add(normal_lpdf<false>(theta, 0, 1));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
